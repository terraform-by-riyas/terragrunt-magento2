...
dependencies {
  paths = ["../../../aws-data", "../../../vpc", "../../../sgs/sg-redis", "../../ssh-key","../../ec2-instance-connect"]
}
dependency "aws-data" {
...
inputs = {
    ...
    instance_type          = "r7g.medium" //memory optimized ARM
    disable_api_termination = false
    create_spot_instance = true
    spot_wait_for_fulfillment = true
    key_name               = dependency.ssh-key.outputs.key-name
    monitoring             = false
    vpc_security_group_ids = [dependency.sg-redis.outputs.security_group_id] // http and https
    subnet_id = dependency.vpc.outputs.private_subnets[0] // Public Subnet
